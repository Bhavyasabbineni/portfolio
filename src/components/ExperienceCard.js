    ...
    return (
        <>
            <Grid
                ...
                item
            >
                <div className={company.includes("American Airlines") ? classes.aalogoContainer : classes.logoContainer}>
                    {
                        company.includes("American Airlines")
                            ?
                            <img alt="AA-icon" className={classes.companyLogo} src={require("../assets/images/aalogo.png")} />
                            :
                            company.includes("ATT")
                                    ?
                                    <img alt="ATT-icon" className={classes.companyLogo} src={require("../assets/images/ATT.PNG")} />
                                    :
                                    <img alt="qualcomm-icon" className={classes.companyLogo} src={require("../assets/images/Qualcomm.png")} />
                    }
